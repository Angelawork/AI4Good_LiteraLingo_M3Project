...
scores = scorer.score(candidates=candidates, references=list_metonymic_column)

#print('For figurative-nlp/t5-figurative-paraphrase model,the average BLEURT score for METONYMIES is {}'.format(np.mean(scores)))
#Get:For figurative-nlp/t5-figurative-paraphrase model,the average BLEURT score for METONYMIES is 0.48975935354828837     
print('For figurative-nlp/sarcasm-hyperbole-humor-paraphrase model,the average BLEURT score for METHONYMIES is {}'.format(np.mean(scores)))
#Get:For figurative-nlp/sarcasm-hyperbole-humor-paraphrase model,the average BLEURT score for METHONYMIES is 0.6349983891844749
