...
scores = scorer.score(candidates=candidates, references=list_hyperbole_column)   

print('For figurative-nlp/t5-figurative-paraphrase model,the average BLEURT score for HYPERBOLE is {}'.format(np.mean(scores)))
#Get:For figurative-nlp/t5-figurative-paraphrase model,the average BLEURT score for HYPERBOLE is 0.6017162628471852    
#print('For figurative-nlp/sarcasm-hyperbole-humor-paraphrase model,the average BLEURT score for HYPERBOLE is {}'.format(np.mean(scores)))
#Get:For figurative-nlp/sarcasm-hyperbole-humor-paraphrase model,the average BLEURT score for HYPERBOLE is 0.7668591256439686
