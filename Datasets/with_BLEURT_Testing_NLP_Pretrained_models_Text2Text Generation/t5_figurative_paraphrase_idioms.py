...
scores = scorer.score(candidates=candidates, references=list_idioms_column)

#print('For figurative-nlp/t5-figurative-paraphrase model,the average BLEURT score for IDIOMS is {}'.format(np.mean(scores)))
#Get:For figurative-nlp/t5-figurative-paraphrase model,the average BLEURT score for IDIOMS is -0.05678766831755638     
print('For figurative-nlp/sarcasm-hyperbole-humor-paraphrase model,the average BLEURT score for IDIOMS is {}'.format(np.mean(scores)))
#Get:For figurative-nlp/sarcasm-hyperbole-humor-paraphrase model,the average BLEURT score for IDIOMS is 0.8051432381570339 
